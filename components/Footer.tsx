        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              We are a full-service digital agency helping businesses grow through innovative web design, development, and digital marketing solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">UX/UI Design</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Business Consulting</Link></li>
            </ul>
          </div>
